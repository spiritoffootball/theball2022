<?php /*
================================================================================
The Ball 2022 Archive Template
================================================================================
...
<div class="main_column clearfix">
	...
	<?php if ( have_posts() ) : ?>
		...
		// Search Nav.
		$pl = get_next_posts_link( __( '&laquo; Older Posts', 'theball2022' ) );
		$nl = get_previous_posts_link( __( 'Newer Posts &raquo;', 'theball2022' ) );
		...
		<div class="main_column_inner">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="post">
					...
					<p class="postmetadata"><?php the_tags( __( 'Tags: ', 'theball2022' ), ', ', '<br />' ); ?> <?php _e( 'Posted in ', 'theball2022' ) . the_category( ', ' ) ?> | <?php comments_popup_link( __( 'No Comments &#187;', 'theball2022' ), __( '1 Comment &#187;', 'theball2022' ), __( '% Comments &#187;', 'theball2022' ) ); ?></p>
	...
	<?php else : ?>
		...
		<div class="main_column_inner" id="main_column_splash">
			...
			<div class="post">
			<div class="post_header archive_header">
				<h2 class="pagetitle"><?php _e( 'Nothing found', 'theball2022' ); ?></h2>
			</div>
			</div>
		...
		<div class="main_column_inner">
			...
			<div class="entrytext clearfix">
				...
				<p><?php _e( 'Try searching for something?', 'theball2022' ); ?></p>
