...
<div id="site_banner" class="clearfix">
	...
	<div id="site_banner_inner">
		...
		<div id="splash">
			...
			<a href="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/interface/crowd-and-ball.jpg"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/interface/crowd-and-ball.jpg" alt="The Sphere of Influence" title="The Sphere of Influence" width="200" height="139" class="alignnone size-medium wp-image-122" /></a>
