...
define( 'THEBALL2022_VERSION', '1.0.0' );
...
add_action( 'after_setup_theme', 'theball2022_setup' );
 ...
 * @since 1.0
 */
function theball2022_enqueue_styles() {
...
add_filter( 'wp_enqueue_scripts', 'theball2022_enqueue_styles', 105 );
 ...
 */
function theball2022_theball_image( $default ) {

	// ignore default and set our own
	return '<a href="' . get_option( 'home' ) . '" title="' . __( 'Home', 'theball2022' ) . '" class="ball_image">' .
 ...
 */
function theball2022_supporters_file( $default ) {
...
// add a filter for the above
add_filter( 'theball_supporters', 'theball2022_supporters_file', 10, 1 );
 ...
 */
function theball2022_team_members( $default ) {
...
// add a filter for the above
//add_filter( 'theball_team_members', 'theball2022_team_members', 10, 1 );



/**
 * The Ball 2022 Gallery Shortcode Filter Class.
 *
 ...
 * @since 1.0.3
 */
class The_Ball_2022_Gallery_Filter {
